...
define dmc = Character("dalam pikiran [name]")
...
# Musik sementara (bajakan)
        ...
        dmc "{cps=25}Padahal gue habis Galau berat lah ASTAGAAA........{/cps}"
        ...
        dmc "{cps=25}CkckckCk waduhh... dia emang temen dekat gue dulu sih.., tapi kalo udah kek gini beda cerita lah anjir. mending gw nyerah aja lah{/cps}"
        mc "{cps=40}Ehmm{/cps}"
