...
# Bagian ini akan berisi alur utama yang dimana mc akan lupa nama temannya dan bertanya kemudian mereka bakalan kerumah si mc selagi mengerjakan PR Matimatikam bareng. Dan untuk next part atau babnya nanti mereka bakalan sering ketemu karena temennya si mc atau putri udah tau rumah mc
    ...
    label kerumahMcBareng1:
        ...
        sh "{cps=17}kemudian kami langsung masuk ke ruang tamu, karena kelihatan tidak ada orang di rumah{/cps}"
        hide bg blck
        stop music
        ...
        show bg blck
        with dissolve
        sh "{cps=17}Kami pun mulai mengerjakan PR Matematika bersama-sama{/cps}"
        sh "{cps=17}Dengan saling bertanya satu sama lain ketika kebingungan{/cps}"
        sh "{cps=17}Kami pun selesai mengerjakan dalam waktu yang cukup singkat{/cps}"
        sh "{cps=17}Dalam sisa waktu yang kami habiskan sebelum hari menjelang malam{/cps}"
        sh "{cps=17}Tanpa kami sadari waktu pun berlalu setelah kami berbicara tentang Jurusan kuliah{/cps}"
        hide bg blck
    ...
    label kerumahMcBareng21:
        ...
        sh "{cps=17}Apalagi nafasku yang sedang terengah-engah saat lari{/cps}"
        sh "{cps=17}Setelah beberapa waktu sampai sekarang, perjalanan kami dari tempat duduk umum pun berakhir {/cps}"
        sh "{cps=25}Kami berdua pun sampai di rumahku {/cps}"
        sh "{cps=17}kemudian kami langsung masuk ke ruang tamu, karena kelihatan tidak ada orang di rumah{/cps}"
        hide bg blck
        ...
        sh "{cps=17}Kami pun mulai mengerjakan PR Matematika bersama-sama{/cps}"
        sh "{cps=17}Dengan saling bertanya satu sama lain ketika kebingungan{/cps}"
        sh "{cps=17}Kami pun mengerjakannya dengan penuh bahagia dan canda tawa{/cps}"
        sh "{cps=17}Sampai kami lupa akan apa yang membatasi kami{/cps}"
        sh "{cps=17}Yaitu waktu yang sudah menunjukan pukul 18.00{/cps}"
        hide bg blck
    ...
    label kerumahMcBareng23:
        ...
        sh "{cps=17}Kami pun mulai mengerjakan PR Matematika bersama-sama{/cps}"
        sh "{cps=17}Dengan saling bertanya satu sama lain ketika kebingungan{/cps}"
        sh "{cps=17}Kami pun mengerjakannya dengan sederhana dan sedikit bercanda{/cps}"
        sh "{cps=17}Akhirnya pun tugas kami selesai{/cps}"
        sh "{cps=17}Akan tetapi, ternyata tiba-tiba Ibuku datang dan bertanya {/cps}"
        hide bg blck
    ...
    label kerumahMcBareng3:
        ...
        sh "{cps=17}Kami pun mulai mengerjakan PR Matematika bersama-sama{/cps}"
        sh "{cps=17}Dengan saling bertanya satu sama lain ketika kebingungan{/cps}"
        sh "{cps=17}Kami pun selesai mengerjakannya dengan puas{/cps}"
        sh "{cps=17}Dalam sisa waktu yang kami habiskan sebelum hari menjelang malam{/cps}"
        sh "{cps=17}Tanpa kami sadari waktu pun berlalu setelah kami baru saja selesai mengerjakan PR kami{/cps}"
        hide bg blck
...
#  KHUSUS label ini terdapat pembicaraan mc dengan ortu teman yg duduk disampingnya, yaitu si putri. jadi, Khusus dibagian ini mereka gaakan main bareng. Serta, Putri bakalan didukung untuk memilih jalan hidupnya nanti saat lulus
        ...
        sh "{cps=17}Di perjalanan kami berdua terdiam entah kenapa{/cps}"
        sh "{cps=17}Menurutku mungkin dia sedang memikirkan bagaimana pembicaraan kami nanti dengan orang tuanya{/cps}"
        sh "{cps=17}Setelah beberapa waktu sampai sekarang, perjalanan kami dari tempat duduk umum pun berakhir {/cps}"
...
# Akan terjadi penjelasan kepada Ibunya dahulu kemudian ayahnya karena belum pulang kerja. Kemudian untuk cara menjelaskannya berbeda karena Ibu butuh perasaan kemudan Ayah butuh logika.
        ...
        pttm "{cps=25}Kebetulan Papahku belum pulang kerja, jadi kita bakalan bicara dengan Ibuku dulu{/cps}"
        mcd "{cps=25}Hmmm, lumayan untuk mengurangi panas suasana nanti{/cps}"
        mc "{cps=25}Oh, bagus tuh{/cps}" 
        pttm "{cps=25}Kenapa memangnya?{/cps}"
        mcd "{cps=25}Sepertinya aku lebih baik tidak memberitahunya dulu{/cps}"
        mc "{cps=25}Liat aja nanti..{/cps}" 
        pttm "{cps=25}Okelah kalo gitu{/cps}"
        mc "{cps=25}Btw lumayan bagus juga rumahmu{/cps}"
    ...
    label debatIbuPutri2:
        ...
        ibuputri "{cps=25}Memangnya saran seperti apa?{/cps}"
        mcd "{cps=25}Nah ini dia waktunya....{/cps}"
    ...
    label debatIbuPutri3:
        ...
        ibuputri "{cps=25}MASIH MAU BAHAS MASALAH ITU KAMU..?{/cps}"
        ibuputri "{cps=25}Sekarang mau temanmu sekalian tau juga?{/cps}"
        pt "{cps=25}Mm....m......{/cps}"  
        pt "{cps=25}Pu...Putri se..se....benarnya mau bicara... masalah ini cukup lama..{/cps}"  
        ibuputri "{cps=25}Memangnya apa yang belum kamu bahas dari dulu!?{/cps}"
        pt "{cps=25}Putri memang dari dahulu mau jadi dokter, tapi kan enggak mau Mamah dan Papahnya{/cps}"  
        ibuputri "{cps=25}TERUS!??{/cps}"
        pt "{cps=25}Kalo ini tetap berlanjut, Putri malah tidak bisa belajar dengan baik dan Putri malah merasa tertekan karenanya perasaan Putri nggak mau....{/cps}"  
        ibuputri "{cps=25}Di dunia pekerjaan, para pekerja yang pasti mencari uang yang aman dan mudah juga pastinya{/cps}"
        ibuputri "{cps=25}Kenapa kamu ngeyel buat nyari yang susah dan beresiko tinggi dibandingkan yang mudah kayak PNS yang Mamah dan Papah kerjakan{/cps}"
        ibuputri "{cps=25}Sudah biayanya mahal untuk kuliah, sekarang banyak yang tidak berhasil lagi...{/cps}"
        ibuputri "{cps=25}Dan malah walaupun berhasil, kebanyakan dari mereka hanya jadi dokter gadungan yang membahayakan Pasiennya{/cps}"
        ibuputri "{cps=25}Kamu memangnya sanggup untuk itu!?{/cps}"
        pt "{cps=25}..................{/cps}"  
        mcd "{cps=25}Hmm.... aku sepertinya perlu membiarkannya bicara sendiri untuk dia juga{/cps}"
        mcd "{cps=25}Tapi jika aku tidak membantunya, sepertinya ini tidak akan berhasil{/cps}"
        mcd "{cps=25}Ketika dia kebingungan sepertinya aku akan membantunya seperti saat ini. Akan kuingat untuk sedikit bicara{/cps}"
        mc "{cps=25}Bu...{/cps}"
        mc "{cps=25}Darimana bukti kalo informasi yang Ibu dapatkan itu sudah benar dengan kenyataannya?{/cps}"
        ibuputri "{cps=25}Bukti....?{/cps}"
        ibuputri "{cps=25}Kamu perlu buktinya...?{/cps}"
        ibuputri "{cps=25}Kalo begitu ini semua dari pengalaman yang saya dan suami saya lalui{/cps}"
        ibuputri "{cps=25}Sudah cukup JELAS....!?{/cps}"
        mc "{cps=25}Saya punya bukti lain yang sudah Saya teliti secara matang{/cps}"
        mc "{cps=25}Dan karena Saya sudah berbicara dengan Putri tentang ini...{/cps}"
        mc "{cps=25}Coba saja Ibu tanyakan langsung dengannya{/cps}"
        ibuputri "{cps=25}Bukti apa yang memangnya buat jadi Dokter lebih baik daripada jadi PNS Putri!?{/cps}"
